...
<body class="list">
<div class="bar">
    t_admin列表&nbsp;总记录数: ${pager.totalCount} (共${pager.pageCount}页)
</div>
<div class="body">
    <form id="listForm" action="${base}/admin/list" method="get">
        <div class="listBar">
            <input type="button" class="formButton" onclick="location.href='${base}/admin/add'" value="添加t_admin"
                   hidefocus/>
            &nbsp;&nbsp;
            <label>查找:</label>
            &nbsp;&nbsp;
        ...
        <div class="listTable_outer">
            <table id="listTable" class="listTable">
                <tr class="noHover">
                    ...
                    <th>
                        <a href="#" name="username" hidefocus></a>
                    </th>
                    <th>
                        <a href="#" name="password" hidefocus></a>
                    </th>
                    <th>
                        <a href="#" name="name" hidefocus>姓名</a>
                    </th>
                    <th>
                        <a href="#" name="headImg" hidefocus></a>
                    </th>
                    <th>
                        <a href="#" name="loginDate" hidefocus></a>
                    </th>
                    <th>
                        <a href="#" name="loginIp" hidefocus></a>
                    </th>
                    <th>
                        <a href="#" name="isLock" hidefocus></a>
                    </th>
                    <th>
                        <a href="#" name="loginFailureCount" hidefocus></a>
                    </th>
                    <th>
                        <a href="#" name="lockDate" hidefocus></a>
                    </th>
                    <th>
                        <span>操作</span>
                    </th>
            ...
            <div class="pagerBar">
                <div class="delete">
                    <input type="button" id="deleteButton" class="formButton" url="${base}/admin/delete" value="删 除"
                           disabled hidefocus/>
                </div>
                <div class="pager">
                    <#include "pager.ftl" />
