...
<body class="list">
<div class="bar">
    t_code_source列表&nbsp;总记录数: ${pager.totalCount} (共${pager.pageCount}页)
</div>
<div class="body">
    <form id="listForm" action="${base}/codeSource/list" method="get">
        <div class="listBar">
            <input type="button" class="formButton" onclick="location.href='${base}/codeSource/add'"
                   value="添加t_code_source" hidefocus/>
            &nbsp;&nbsp;
            <label>查找:</label>
            &nbsp;&nbsp;
        ...
        <div class="listTable_outer">
            <table id="listTable" class="listTable">
                <tr class="noHover">
                    ...
                    <th>
                        <a href="#" name="adminName" hidefocus></a>
                    </th>
                    <th>
                        <a href="#" name="fileName" hidefocus></a>
                    </th>
                    <th>
                        <a href="#" name="fileUrl" hidefocus></a>
                    </th>
                    <th>
                        <span>操作</span>
                    </th>
                ...
                <#list pager.result as codeSource>
                    <tr>
                        ...
                        <td>
                            <a href="${base}/codeSource/view/${codeSource.id}" title="查看">[查看]</a>
                            <a href="${base}/codeSource/edit/${codeSource.id}" title="编辑">[编辑]</a>
                        </td>
                    </tr>
                </#list>
            </table>
            ...
            <div class="pagerBar">
                <div class="delete">
                    <input type="button" id="deleteButton" class="formButton" url="${base}/codeSource/delete"
