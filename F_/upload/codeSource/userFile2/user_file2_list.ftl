...
<div class="body">
    <form id="listForm" action="${base}/userFile2/list" method="get">
        <div class="listBar">
            <input type="button" class="formButton" onclick="location.href='${base}/userFile2/add'" value="添加用户文件"
                   hidefocus/>
            &nbsp;&nbsp;
            <label>查找:</label>
            &nbsp;&nbsp;
        ...
        <div class="listTable_outer">
            <table id="listTable" class="listTable">
                <tr class="noHover">
                    ...
                    <th>
                        <a href="#" name="name" hidefocus>am</a>
                    </th>
                    <th>
                        <span>操作</span>
                    </th>
                </tr>
                <#list pager.result as userFile2>
                    <tr>
                        <td>
                            <input type="checkbox" name="ids" value="${userFile2.id}"/>
                        </td>
                        <td>
                            ${(userFile2.name)!}
                        </td>
                        <td>
                            <a href="${base}/userFile2/view/${userFile2.id}" title="查看">[查看]</a>
                            <a href="${base}/userFile2/edit/${userFile2.id}" title="编辑">[编辑]</a>
                        </td>
                    </tr>
                </#list>
            </table>
            ...
            <div class="pagerBar">
                <div class="delete">
                    <input type="button" id="deleteButton" class="formButton" url="${base}/userFile2/delete" value="删 除"
                           disabled hidefocus/>
                </div>
                <div class="pager">
                    <#include "pager.ftl" />
