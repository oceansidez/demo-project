...
<div class="body">
    <form id="validateForm" action="<#if isAdd>${base}/userFile2/save<#else>${base}/userFile2/update</#if>"
          method="post">
        <#if !isAdd>
            <input type="hidden" name="id" value="${userFile2.id}"/>
        </#if>
        <input type="hidden" name="type" value="userFile2"/>
        <ul id="tab" class="tab">
            <li>
        ...
        <table class="inputTable tabContent">
            <tr>
                <th>am:</th>
                <td>
                    <input type="text" name="name" class="formText" value="${(userFile2.name)!}"/>
