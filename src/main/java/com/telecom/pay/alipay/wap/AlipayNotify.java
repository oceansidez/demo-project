package com.telecom.pay.alipay.wap;
...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public static boolean verifyNotify(Map<String, String> params, String partner, String key) throws Exception {
     ...
     * @return 解密后结果
     */
    public static Map<String, String> decrypt(Map<String, String> inputPara, String key) throws Exception {
    	inputPara.put("notify_data", RSA.decrypt(inputPara.get("notify_data"), key, "UTF-8"));
    	return inputPara;
    }
