...
!function () {
	...
	layer.prompt = function (a, c) {
		...
		if (a = a || {}, a.photos) {
			...
			f.imgprev = function (a) {
			...
			}, f.loadi = layer.load(1, {shade:"shade" in a ? !1 : 0.9, scrollbar:!1}), e(i[j].src, function (c) {
				...
				layer.close(f.loadi), layer.msg("&#x5F53;&#x524D;&#x56FE;&#x7247;&#x5730;&#x5740;&#x5F02;&#x5E38;<br>&#x662F;&#x5426;&#x7EE7;&#x7EED;&#x67E5;&#x770B;&#x4E0B;&#x4E00;&#x5F20;&#xFF1F;", {time:30000, btn:["\u4e0b\u4e00\u5f20", "\u4e0d\u770b\u4e86"], yes:function () {
